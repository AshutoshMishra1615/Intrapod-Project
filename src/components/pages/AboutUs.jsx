          ...
          <div className="mb-16">
            ...
            <div className="space-y-6">
              {ourApproach.map((e, index) => (
                <motion.div
                  key={index}
                  className="bg-white p-6 rounded-lg shadow-md flex items-start hover:shadow-lg transition-shadow duration-300"
                ...
                >
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-2">{e.approach}</h3>
