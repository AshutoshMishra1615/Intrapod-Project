    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-white">
            <Card className="w-full max-w-md p-6 shadow-md bg-gray-50 text-black">
                ...
                <p className="text-center text-gray-500 mb-6">Enter your email below to login</p>
                <CardContent>
                    <div className="space-y-6">
                        ...
                        <Button className="w-full bg-[#1a91f0] text-white hover:bg-blue-400" onClick={handleLogin}>Login</Button>
                        ...
                        <p className="text-center text-gray-400">
                            Don’t have an account? <a href="#" className="text-[#1a91f0]">Sign up</a>
                        </p>
                    </div>
                </CardContent>
            </Card>
