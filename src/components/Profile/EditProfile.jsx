          ...
          <ProfileUpload/>
           ...
           <div >E-mail <br /></div>
            ...
            >
              ...
              <NavLink className="border-1 px-4 py-2 border-[#1A91F0] text-[#1A91F0] rounded" to={"/"}>Cancel</NavLink>
              
             <button type="submit" className="border-1 px-4 py-2 rounded bg-[#1A91F0] text-white">Update</button>
             </div>
          </form>
